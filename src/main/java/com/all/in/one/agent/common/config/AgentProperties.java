...
public class AgentProperties {
     ...
     * 存储策略配置
     */
    private StorageStrategy storageStrategy = new StorageStrategy();
    ...
    public static class StorageStrategy {
         ...
         * 是否启用 HTTP 上报
         */
        private boolean enableHttpReport = false;

        /**
         * 是否启用本地持久化
         */
        private boolean enableLocalPersistence = true;

        /**
         * 是否自动生成工单
         */
        private boolean enableTicketGeneration = true;
    }
